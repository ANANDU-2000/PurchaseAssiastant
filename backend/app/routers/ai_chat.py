"""HEXA AI — chat stub + structured intent (wire OpenAI / Sarvam later; keys stay on server)."""
...
from app.deps import charge_ai_stub_turn, require_membership
...
async def ai_chat(
    ...
    user: Annotated[User, Depends(charge_ai_stub_turn)],
