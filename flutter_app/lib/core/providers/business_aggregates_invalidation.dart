...
/// After stock save — immediately reconcile list by default so the user sees
/// updated values on sheet pop. [light] mode skips item-detail/home/bulk refetch
/// storm but still reconciles the stock list.
void invalidateWarehouseSurfacesAfterStockWrite(
  dynamic ref, {
  String? itemId,
  bool deferFullList = false,
  bool light = false,
}) {
