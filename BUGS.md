...
| BUG-004 | P1 | Purchase deleted in UI but data/cache still surfaces | **partial** — backend month dashboard no longer counts `status=deleted`; Flutter surfaces still need full audit (all delete entry points, provider invalidation) |
